...
import { APIKEY, APIKEY2, APIKEY3, LOGO } from "../Utils/Constants";
...
const Header = () => {
 ...
 console.log(channel)
    ...
    youtube();
      ...
      const youtube = async ()=>{
        try{
          const data= await fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&&chart=mostPopular&regionCode=IN&key=${APIKEY3}&maxResults=40`)
          const json = await data.json();
        const data1= await fetch(`https://youtube.googleapis.com/youtube/v3/channels?part=snippet%2CcontentDetails%2Cstatistics%2Cstatus&id=UCkWOpf05w9dPthQ-2tXndfA&key=${APIKEY3}`)
